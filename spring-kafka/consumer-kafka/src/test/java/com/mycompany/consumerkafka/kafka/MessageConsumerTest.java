...
class MessageConsumerTest {
    ...
    @Test
    void testListenNews(CapturedOutput output) throws JsonProcessingException, InterruptedException {
        String id = "id";
    ...
    @Test
    void testListenAlert(CapturedOutput output) throws JsonProcessingException, InterruptedException {
        String id = "id";
